...
export const sequenceTemplates: SequenceTemplate[] = [
    ...
    },
    {
        ...
        steps: [
            { delay_hours: 0, message_template: 'Hi {{firstName}},\n\nGreat speaking with you! 🎉\n\nI\'m excited to help {{company}} transform your lead management process.\n\nNext steps:\n1. I\'ve attached our onboarding guide\n2. We\'ll send calendar invite shortly\n3. Looking forward to our deep-dive session\n\nBest,\n{{senderName}}', channel: 'email', ai_icebreaker: false, ai_autopilot: false, template_subject: 'Welcome to Payoff Lab, {{firstName}}! 🚀' } as SequenceStep,
            { delay_hours: 24, message_template: 'Hi {{firstName}},\n\nQuick check-in! 📋\n\nHave you reviewed the onboarding materials?\n\nResources:\n• Getting Started Guide\n• Best Practices PDF\n• Video Tutorial Library\n\nQuestions? Just reply!', channel: 'email', ai_icebreaker: false, ai_autopilot: false, template_subject: 'Your Payoff Lab resources are ready' } as SequenceStep,
            { delay_hours: 72, message_template: '{{firstName}},\n\nYour account setup is almost complete! ✨\n\nI\'ve prepared a custom configuration for {{company}}.\n\nReady for our kickoff call? Reply with your preferred time!', channel: 'email', ai_icebreaker: false, ai_autopilot: false, template_subject: 'Ready for your Payoff Lab kickoff?' } as SequenceStep,
    ...
    },
    {
        ...
        steps: [
            { delay_hours: 0, message_template: 'Hi {{firstName}},\n\nThanks for your interest in Payoff Lab! 🚀\n\nI would love to show you how we can help {{company}} automate your lead management in just 15 minutes.\n\nClick here to book a time that works for you: [Calendar Link]\n\nTalk soon!\n{{senderName}}', channel: 'email', ai_icebreaker: false, ai_autopilot: false, template_subject: 'Your Payoff Lab demo is ready to book' } as SequenceStep,
