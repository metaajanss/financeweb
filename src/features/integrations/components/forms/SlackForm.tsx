...
export function SlackForm({ apiKey, setApiKey, channelId, setChannelId, notifyLeads, setNotifyLeads, notifyMeetings, setNotifyMeetings, notifyMessages, setNotifyMessages, notifyErrors, setNotifyErrors, notifyReminders, setNotifyReminders }: SlackFormProps) {
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <input type="text" value={channelId} onChange={(e) => setChannelId(e.target.value)} placeholder="e.g. C0123456789" className="w-full p-3 rounded-lg bg-background border border-border focus:ring-2 focus:ring-primary outline-none" />
            </div>
